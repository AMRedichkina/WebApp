...
from .models import Recipe, Tag, IngredientInRecipe, Amount_ingredients, Favorite, Cart
...
class RecipesSerializer(serializers.ModelSerializer):
    ...
    ingredients = Amount_ingredientsSerializer(source='amount_ingredients_set', many=True, read_only=True)  
